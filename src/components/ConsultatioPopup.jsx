        ...
        {isOpen && (
          ...
          >
            ...
            >
                ...
                <button
                  ...
                  className={`w-full py-3 rounded-xl font-semibold text-white transition ${
                    isSubmitting
                      ...
                      : "bg-[#FF6B35] hover:bg-[#3a7fd9] active:scale-[0.98]"
                  }`}
                >
              ...
              <button
                onClick={onClose}
                className="mt-4 w-full text-[#4C93FF] font-medium hover:text-white p-2 rounded-xl border-2 border-[#4C93FF] transition  hover:bg-[#3a84f0]"
              >
                Cancel
              </button>
            </motion.div>
