  ...
  return (
    ...
    >
      ...
      <motion.h1
        ...
        className="relative z-10 text-white text-4xl sm:text-5xl md:text-6xl font-extrabold tracking-wide drop-shadow-lg font-serif px-4"
      >
        {title}
      </motion.h1>
      ...
      <motion.div
        ...
        className="relative z-10 mt-4 flex items-center gap-2 text-white/90 text-base sm:text-lg font-serif"
      >
        <Link
          to="/"
      ...
      <div className="absolute bottom-0 left-0 w-full overflow-hidden leading-[0]">
        ...
        >
          <path
            d="M0,60 C300,10 600,110 900,60 C1000,45 1100,50 1200,60 L1200,120 L0,120 Z"
            fill="white"
          />
        </svg>
      </div>
